...
const questions = [
    ...
    {
        id: "annee",
        question: "En quelle année souhaites-tu partir ?",
        options: ["4A", "5A"],
    },
    {
        id: "moyenne",
        question: "Ta moyenne du dernier semestre ?",
        options: ["< 10", "10-12", "12-14", "> 15"],
    },
    {
        id: "continent",
        question: "Quel continent t'attire ?",
        options: [
            "Europe",
            "Amérique du Nord",
            "Amérique Latine",
    ...
    {
        id: "mobilité",
        question: "Quel type d'accord de mobilité envisages-tu ?",
        options: [
            "Accord de mobilité (1 semestre)",
            "Erasmus+",
            "Double Diplôme",
            "UNITECH",
        ],
    ...
    },
    {
        ...
        options: [
            "Chaleur et soleil",
            "Grand froid et neige",
            "Tempéré / Peu importe",
        ],
    },
    {
        id: "domaine",
        question: "Ton domaine technique ?",
        options: [
            "IA et Data Science",
    ...
    const handleFinish = async (finalAnswers: Record<string, string>) => {
        ...
        try {
            ...
            if (!Array.isArray(data.recommendations) || data.recommendations.length === 0) {
                setErrorMsg("L'IA n'a pas pu générer de recommandations. Réessaie !");
                return;
            }
            ...
            setErrorMsg(
                "Impossible de joindre le serveur. Vérifie ton terminal Rust !",
            );
        } finally {
            setIsLoading(false);
        }
    ...
    return (
        <main className="quiz-page">
            ...
            {!isFinished ? (
                ...
                <div
                    className={
                        isLoading ? "quiz-container" : "results-container"
                    }
                >
                    {isLoading ? (
                                ...
                                <div className="recommendations-list">
                                    {recommendations?.map((rec, index) => (
                                        ...
                                        >
                                            ...
                                            <p className="rec-avis">
                                                {rec.avis}
                                            </p>
                                            <div className="rec-tags">
                                                {rec.points_forts.map(
                                                    (tag, i) => (
                                                        <span
                                                            key={i}
                                                            className="rec-tag"
