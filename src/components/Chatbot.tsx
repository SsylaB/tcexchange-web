...
export default function Chatbot() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await findBestAnswer(trimmedInput, conversationHistory);
          ...
          <div className="chatbot__header">
            <div className="chatbot__header-left">
              <div className="chatbot__avatar" aria-hidden="true">
                <img
                  src="/chatboticon3.png"
                  alt="Chatbot"
                  className="chatbot__avatar-img"
                />
              </div>
              <div>
                <div className="chatbot__title">TC Assistant</div>
                <div className="chatbot__subtitle">En ligne</div>
              </div>
            </div>
